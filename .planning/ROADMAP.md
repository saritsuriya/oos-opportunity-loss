...
- [x] 01-02: Implement temporary run workspace handling and cleanup behavior
- [x] 01-03: Configure lean internal deployment for the chosen host environment
...
- [x] 02-02: Implement schema validation and ingestion warnings
- [x] 02-03: Build upload UI for sales, stock, and SKU files plus bundled site-mapping visibility
...
Plans:
- [x] 03-01: Extract V5 calculation engine from script form into reusable backend code
- [x] 03-02: Implement run orchestration, error handling, and session-visible status
- [x] 03-03: Build the run-step UI and same-step outcome workflow
